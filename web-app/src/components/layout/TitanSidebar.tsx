...
const NAV_ITEMS = [
    ...
    { href: "/training", label: "Bio-Engine", icon: Dumbbell },
    { href: "/nutrition", label: "Nutrition", icon: Utensils },
    { href: "/vision", label: "Vision AI", icon: Eye },
    { href: "/progress", label: "Progress", icon: LayoutGrid },
    { href: "/social", label: "Tribe", icon: Users },
    { href: "/biohacking", label: "Bio-Hack", icon: Brain },
];
...
export function TitanSidebar() {
    ...
    return (
        <motion.div
            ...
            className="fixed top-0 left-0 h-screen w-64 bg-white/80 backdrop-blur-xl border-r border-slate-200 z-50 flex flex-col shadow-2xl"
        >
            {/* Logo Area */}
