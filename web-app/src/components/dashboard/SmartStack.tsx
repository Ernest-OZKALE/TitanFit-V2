...
export function SmartStack() {
    ...
    return (
        <div className="space-y-4">
            <FocusModeOverlay isActive={isFocusMode} onClose={() => setIsFocusMode(false)} />
            ...
            <div className="flex items-center justify-between px-1">
                ...
                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest bg-white/5 px-2 py-0.5 rounded-full border border-white/10">Active Protocol</span>
            </div>
