        ...
        <Card className="bg-black/40 backdrop-blur-xl border-white/10 shadow-2xl relative overflow-hidden group">
            ...
            <CardContent className="p-6 space-y-6">
                ...
                <div className="p-4 bg-gradient-to-r from-[#D4AF37]/10 to-transparent rounded-2xl border-l-2 border-[#D4AF37] text-[11px] text-gray-300">
                    <p className="font-black text-[#D4AF37] mb-2 uppercase tracking-widest">Algorithme Neural Precision</p>
                    <ul className="space-y-1 opacity-80 font-medium">
                        ...
                        <li className="flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#D4AF37]" /> Corrélation 10k+ profils Titan</li>
                        <li className="flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#D4AF37]" /> Synchronisation métabolique</li>
                    </ul>
                </div>
            </CardContent>
        </Card>
