        ...
        <div className="min-h-screen flex relative overflow-hidden text-slate-900 bg-white">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative z-10 items-center justify-center p-12">
                ...
                >
                    ...
                    <p className="text-2xl mb-4 font-light text-slate-600">Commencez Votre Transformation.</p>
                    <p className="text-lg text-slate-500 mb-12 leading-relaxed">
                        Rejoignez l'élite et propulsez vos performances au niveau supérieur grâce à notre technologie Titan.
                    </p>

                    <div className="space-y-6">
                        <div className="flex items-center space-x-4 group">
                            <div className="w-10 h-10 rounded-full bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] border border-[#D4AF37]/20 group-hover:scale-110 transition-transform shadow-sm">✓</div>
                            <div>
                                <h3 className="font-bold text-slate-900 group-hover:text-[#D4AF37] transition-colors">Gratuit Pour Toujours</h3>
                                <p className="text-sm text-slate-500">Aucune carte bancaire requise pour démarrer</p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-4 group">
                            <div className="w-10 h-10 rounded-full bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] border border-[#D4AF37]/20 group-hover:scale-110 transition-transform shadow-sm">✓</div>
                            <div>
                                <h3 className="font-bold text-slate-900 group-hover:text-[#D4AF37] transition-colors">Propulsé par l'Algorithme</h3>
                                <p className="text-sm text-slate-500">Coaching intelligent adaptatif</p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-4 group">
                            <div className="w-10 h-10 rounded-full bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] border border-[#D4AF37]/20 group-hover:scale-110 transition-transform shadow-sm">✓</div>
                            <div>
                                <h3 className="font-bold text-slate-900 group-hover:text-[#D4AF37] transition-colors">Confidentialité Totale</h3>
                                <p className="text-sm text-slate-500">Vos données restent privées</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10">
                ...
                >
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="text-slate-500">Rejoignez la légende en quelques secondes.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            <Label htmlFor="username" className="text-slate-700 text-sm font-medium ml-1">Nom d'utilisateur</Label>
                            <Input
                                id="username"
                                type="text"
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 text-sm">
                            ...
                            <Link href="/login" className="text-[#D4AF37] font-semibold hover:text-[#B8860B] transition-colors">
                                Se connecter
                            </Link>
                        </p>
                    </div>
