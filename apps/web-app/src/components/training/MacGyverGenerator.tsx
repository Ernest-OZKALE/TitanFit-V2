    ...
    return (
        <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
                <div className="p-6 bg-zinc-900 rounded-3xl border border-white/10 shadow-sm space-y-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-2xl font-black text-white">{duration} min</span>
                        </div>
                        <input
                            ...
                            {["bodyweight", "dumbbells", "gym"].map(opt => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        equipment === opt ? "border-[#D4AF37] bg-[#D4AF37]/5 text-[#D4AF37]" : "border-white/10 text-gray-400 hover:border-white/20"
                                    )}
                                >
                                    {opt}
                                </button>
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            ...
                            <span className={cn("text-xl font-black", intensity > 8 ? "text-red-500" : "text-white")}>
                                {intensity}/10
                            </span>
                        </div>
                        <input
            ...
            <div className="relative min-h-[400px]">
                {generatedWorkout ? (
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <h3 className="text-2xl font-black text-white">Protocol Generated.</h3>
                            <span className="px-3 py-1 bg-[#D4AF37] text-black text-xs font-bold uppercase rounded-lg">
                            ...
                            {generatedWorkout.map((exo, i) => (
                                <GlassCard key={i} className="flex items-center justify-between p-4 group hover:border-[#D4AF37]">
                                    <div className="flex items-center gap-4">
                                        <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center font-bold text-gray-400">
                                            {i + 1}
                                        </div>
                                        <div>
                                            <h4 className="font-bold text-white">{exo.name}</h4>
                                            <p className="text-xs text-gray-500">{exo.sets} sets x {exo.reps}</p>
                                        </div>
                                    </div>
                    ...
                    <GlassCard className="h-full flex flex-col items-center justify-center text-center p-8 opacity-60">
                        ...
                        <h3 className="text-xl font-bold text-white mb-2">MacGyver Mode Ready</h3>
                ...
                {isGenerating && (
                    ...
                    >
                        ...
                        <span className="font-bold text-white uppercase tracking-widest text-xs">Computing Loads...</span>
                    </motion.div>
                )}
            </div>
