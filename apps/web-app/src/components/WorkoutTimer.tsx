    ...
    return (
        <Card className="bg-zinc-900/80 border border-white/10 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-2 justify-center mb-4">
                        {[30, 60, 90, 120].map(secs => (
                            <Button
                                ...
                                className={duration === secs ? 'bg-[#D4AF37]/20 border-[#D4AF37] text-[#D4AF37]' : 'bg-white/5 border-white/10 text-white'}
                            >
                                {secs}s
                            </Button>
                        ))}
                ...
                {timeLeft === 0 && (
                    <div className="text-center p-4 bg-emerald-500/20 border border-emerald-500/30 rounded-lg animate-pulse">
                        <p className="font-bold text-emerald-400">Repos terminé ! 💪</p>
                    </div>
                )}
            </CardContent>
        </Card>
